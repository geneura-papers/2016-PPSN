...
three values of $\alpha$,  % differences between statistical
                             % variables, not parameters like alpha. - JJ PABLO: you are right, changed to "the results of apply"
for GRANTED and STRONGDENY. In the case of comparing the three distributions for STRONGDENY, an ANOVA test has been applied instead Kruskal-Wallis, as these distributions follow a normal curve.  %this means you have
                                %different alphas for granted and
                                %strongdeny? please clarify - JJ PABLO: Rewritten, more clear now
