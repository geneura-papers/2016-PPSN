...
\end{tabular}
\caption{Results obtained when the individual is coded as a set of rules, following the Pittsburgh approach. Two different fitness have been used, and for $\alpha$ values of 0, 0.5, and 1.}
...
\end{tabular}
\caption{Results obtained when the individual is coded as a single rule, following the Michigan approach, and represented by class. Two different fitness have been used, and for $\alpha$ values of 0, 0.5, and 1.}
\label{tab:michigan}
\end{center}
\end{table*}
