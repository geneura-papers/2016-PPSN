...
\title{Automatic rule extraction using Genetic Programming in a ``Bring Your Own Device'' scenario
}


\author[ugr]{Paloma de las Cuevas}
\ead{palomacd@ugr.es}
\author[uca]{Pablo Garc\'ia-S\'anchez}
\ead{pablo.garciasanchez@uca.es}
\author[abe,laro]{Zaineb Chelly Dagdia}
\ead{zaineb.chelly@aber.ac.uk, chelly.zaineb@gmail.com}
\author[ugr]{Mar\'ia-Isabel Garc\'{\i}a-Arenas}
\ead{mgarenas@ugr.es}
\author[ugr]{Juan Juli\'an Merelo}
\ead{jmerelo@geneura.ugr.es}


\address[ugr]{Department of Computer Architecture and Computer Technology, ETSIIT and CITIC, University of Granada, Granada, Spain.}
\address[uca]{Department of Computer Engineering, ESI, University of C\'adiz, Spain}
\address[abe] { Department of Computer Science, Aberystwyth University, Aberystwyth, UK}
\address[laro]{ LARODEC, Institut Sup\'erieur de Gestion de Tunis, Tunis, Tunisia}
...
\begin{keyword}
Bring Your Own Device \sep Security \sep Corporate Security Policy \sep Genetic Programming \sep Rule Extraction
\end{keyword}
...
This work has been supported in part by SPIP2017-02116, EphemeCH TIN2014-56494-C4-3-P, DeepBio TIN2017-85727-C4-2-P and TEC2015-68752, and European project MUSES (FP7-318508). 
