...
denies access to company assets, % not only company assets. Also other
...
by allowing or denying employees' access to non-confident % non-confidential? - JJ
...
work. % User data is not specific. What kind of data? - JJ
 ...
 denied, where a warning appears. % Are you going to validate those
                                % warnings? To use them in the
                                % training set? What is BYOD specific
                                % about them? - JJ
