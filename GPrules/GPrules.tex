...
\begin{document}
%
\title{Automatic rule extraction using Genetic Programming in a
...
% ---- Commented out for anonymity and also because it does not belong
% here -- 
...
%data. 
% ----------------- Commented out as it should have been from the
% beginning ------------------------------------------------------
...
% requests, but none about the use
