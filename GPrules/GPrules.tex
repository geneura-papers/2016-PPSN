...
\begin{table*}
	...
	\end{tabular}
	\caption{Comparison between Pittsburgh and Michigan approaches, in terms of the size -- number of rules -- of the best individuals. For the Pittsburgh approach, the size is the size of the tree, whilst in the Michigan approach it is the length of the list. The best value is not indicated given that we did not find statistically significant differences.}
	\label{tab:PvsMsize}
\end{table*}
