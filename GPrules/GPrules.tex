...
\begin{document}
%
\title{Automatic rule extraction using Genetic Programming in a ``Bring Your Own Device'' scenario\thanks{This work has been supported in part by SPIP2017-02116, EphemeCH TIN2014-56494-C4-3-P, DeepBio TIN2017-85727-C4-2-P and TEC2015-68752, and European project MUSES (FP7-318508). }}
%
...
anywhere. 
Other advantages are tied to the increase of worker satisfaction, attracting the best candidates, and the increase of engagement in the workplace and after hours \cite{singh2012byod,Doargajudhur2019BYODimpact}. 
...
important company assets \cite{Man2018BYODchallenges}. Therefore, the main issue in the adaptation to a BYOD scenario is to obtain a high level
...
security requirements \cite{Man2018BYODchallenges}. This trend is inevitable as enterprises are
