...
over time to smaller, more reliable and faster high-tech devises such% devises is the British way of writing it? - JJ
...
the ``Bring Your Own Device'' (BYOD) concept or philosophy. % add reference here. 
...
% (Zaineb) Ok :)
Other advantages are tied to the increase of worker satisfaction,  attracting the best applicants and the increase of engagement in the workplace and after hours. % references too - JJ
