...
In the case of $F_{Acc}$ for the Pittsburgh approach, as the distributions are not normal, a non-parametric test (Friedman) has been used to asset the statistical significance \cite{DerracTests11}, obtaining a p-value of 0.0001. $\alpha$ = 0 is significantly different with $\alpha$ = 0.5 and $\alpha$ = 1, while there are not differences between the two former (p-value = 0.08).
