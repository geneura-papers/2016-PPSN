...
In Section \ref{subsec:fitnesscomparison} we showed that the performance in the
...
The results in Section \ref{sec:gp} make a fine proof of concept for a tool that helps the CSO of a company discovering dangerous situations through the presentation of GP generated rules. We obtained promising rates for the number of false positives (around
