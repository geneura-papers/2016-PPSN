...
\begin{itemize}
  \item Attributes given by the ``event detector'' in the application: these attributes are related to the type of the event (action), its timestamp, or the application which originated the event, among others.
