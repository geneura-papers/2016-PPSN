...
\caption{Fitness comparison between Pittsburgh and Michigan approaches. Note that in the case of $f_{Acc}$, the best value is highest, whilst for $f_{CS}$, the lower is better. An $*$ indicates the  statistically significant best value for $\alpha$.}
