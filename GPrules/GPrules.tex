...
\begin{figure*}[h!tb]
	...
	\caption{An example of best individual obtained when using
          ...
          classify towards the GRANTED class.} %Please explain. left
                                %is yes and right is no? Or the other
                                %way round?
% Can you write down the whole rules generated for STRONGDENY? For
% instance, OR user_role=CONSULTANCY appears twice, the second time
% negated. Are all trees guaranteed to reach al leaves? - JJ
